...
mod test {
    ...
    fn test_zip_list_push_left() {
        ...
        zip.push_left(&[4, 5, 6]);
        assert_eq!(
            &[3, 0, 0, 0, 0, 0, 0, 0, 3, 0, 4, 5, 6, 3, 0, 2, 0, 2, 3, 2, 0, 1, 0, 1, 1, 0],
            zip.0.as_slice()
        );
    }
    ...
    fn test_zip_list_push_right() {
        ...
        assert_eq!(
            &[3, 0, 0, 0, 0, 0, 0, 0, 1, 0, 1, 1, 0, 2, 0, 2, 3, 2, 0, 3, 0, 4, 5, 6, 3, 0],
            zip.0.as_slice()
        );
    }
    ...
    fn test_zip_list_insert_left() {
        ...
        assert_eq!(
            &[3, 0, 0, 0, 0, 0, 0, 0, 1, 0, 1, 1, 0, 3, 0, 4, 5, 6, 3, 0, 2, 0, 2, 3, 2, 0],
            zip.0.as_slice()
        );
    }
    ...
    fn test_zip_list_insert_value_left() {
        ...
        assert_eq!(Some(1), re);
        assert_eq!(
            &[3, 0, 0, 0, 0, 0, 0, 0, 2, 0, 2, 3, 2, 0, 3, 0, 4, 5, 6, 3, 0, 1, 0, 1, 1, 0],
            zip.0.as_slice()
        );
        ...
        assert_eq!(Some(1), re);
        assert_eq!(
            &[4, 0, 0, 0, 0, 0, 0, 0, 3, 0, 4, 5, 6, 3, 0, 1, 0, 7, 1, 0, 2, 0, 2, 3, 2, 0, 1, 0, 1, 1, 0],
            zip.0.as_slice()
        );
    }
    ...
    fn test_zip_list_insert_value_right() {
        ...
        assert_eq!(Some(1), re);
        assert_eq!(
            &[4, 0, 0, 0, 0, 0, 0, 0, 1, 0, 1, 1, 0, 3, 0, 4, 5, 6, 3, 0, 1, 0, 7, 1, 0, 2, 0, 2, 3, 2, 0],
            zip.0.as_slice()
        );
    }
